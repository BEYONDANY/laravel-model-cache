...
namespace Xuhaohao\LaravelModelCache\Traits;

use Closure;
use Xuhaohao\LaravelModelCache\CachedBuilder;
use Xuhaohao\LaravelModelCache\CacheKey;
use Xuhaohao\LaravelModelCache\CacheTags;
...
trait Caching
{
    ...
    protected function makeCacheKey(
        ...
        return (new CacheKey($eagerLoad, $model, $query, $this->macroKey, $this->withoutGlobalScopes,
            $this->withoutAllGlobalScopes))
    ...
    protected function getCacheExpiredSeconds(): string
    {
